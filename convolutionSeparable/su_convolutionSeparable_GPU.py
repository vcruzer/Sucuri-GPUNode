...
d_Output.add_edge(GPU1,0)
d_Input.add_edge(GPU1,1)
d_Kernel.add_edge(GPU1,2)
imW.add_edge(GPU1,3)
imH.add_edge(GPU1,4)
imW2.add_edge(GPU1,5)

#Edges to GPU2 (Columns Kernel)
d_Output.add_edge(GPU2,0)
GPU1.add_edge(GPU2,1)
d_Kernel.add_edge(GPU2,2)
imW.add_edge(GPU2,3)
imH.add_edge(GPU2,4)
