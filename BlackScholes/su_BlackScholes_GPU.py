...
GPU = CudaNode(BlackScholesGPU,8,
...
#Adding edges
CallResultGPU.add_edge(GPU,0) #GPU node returns
PutResultGPU.add_edge(GPU,1) #GPU node returns
StockPrice.add_edge(GPU,2)
OptionStrike.add_edge(GPU,3)
OptionYears.add_edge(GPU,4)
